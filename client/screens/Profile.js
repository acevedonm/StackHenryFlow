        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.userInfoSection}>
                <View style={styles.row}>
                    ...
                    <Text style={{ color: "#777777", marginLeft: 20 }}>{usuario.name}</Text>
                </View>
                <View style={styles.row}>
                    <Icon name="phone" color="#3b3b3b" size={20} />
                    <Text style={{ color: "#777777", marginLeft: 20 }}>{usuario.phone}</Text>
                </View>
                <View style={styles.row}>
                    <Icon name="email" color="#3b3b3b" size={20} />
                    <Text style={{ color: "#777777", marginLeft: 20 }}>{usuario.email}</Text>
                </View>
            </View>
            <View style={styles.userInfoSection}>
