            ...
            <View style={styles.userInfoSection}>
                <View style={{ flexDirection: 'row', marginTop: 15 }}>
                    ...
                    <View style={{ marginLeft: 20 }}>
                        ...
                        <Caption style={styles.caption}>AyeVillarruel</Caption>
                    </View>
                </View>
            </View>
            <View style={styles.userInfoSection}>
                <View style={styles.row}>
                    ...
                    <Text style={{ color: "#777777", marginLeft: 20 }}>Ayelen Villarruel</Text>
                </View>
                <View style={styles.row}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={{ color: "#777777", marginLeft: 20 }}>Ayelen@gmail.com</Text>
                </View>
            </View>
            <View style={styles.userInfoSection}>
